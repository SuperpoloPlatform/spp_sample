...
try {
	...
	VFS.Mount("/shader/snippets", "D:/spp_sdk/data/shader-snippets\\");
	...
	prop_zone.PerformAction('Load',['path','.'],['file','world']);
	...
	// 添加移动和旋转速度 
	prop_pcactor.PerformAction('SetSpeed',['movement',40],['running',2],['rotation',2],['jumping',30]);
	
	// 设定一个mesh的名称。
	prop_pm.PerformAction('SetMesh', ['name','Player']);
	
	prop_ment.PerformAction("InitCD", 
		['offset', [0, 0.0, 0]],
		['body', [0.5,0.5,0.5]],
		['legs', [0.5,0.9,0.5]]
	);
