	...
	PLAYER = {
				...
				property : [
					{
						...
						value : 3		//目前大于0的情况下是正确的；等于0时摄像机会跑到人前面去，前后变反，左右无作用；小于0时，所有功能全变反。
					}
				]
			},
			"pcmover" : {},
				...
				action : [
					{
						...
						param : [
							['name','nan']	//被绑定的模型名称。值：从world.xml中读取
						]
					},
					{
		...
		event : {
			...
			"pctimer_position" : function(e){
				var pos = this.pcarray['pcmesh'].GetProperty("cel.property.position");
