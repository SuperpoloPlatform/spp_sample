...
try {
	...
	bproc = prop_zone.PerformAction('Load',['path','.'],['file','level_shadowmap.xml']);
	...
	alert("try to set InitCD");
	prop_ment.PerformAction('InitCD',['offset',[0, 0.0, 0]],['body',[0.5,0.5,0.5]],['legs',[0.5,0.9,0.5]]);
