...
try {
	...
	bproc = prop_zone.PerformAction('Load',['path','.'],['file','world.xml']);
	...
	//prop_light.PerformAction('SetLight',['name','sun']);
	...
	prop_ment.PerformAction('InitCD',['offset',[0, 0, 0]],['body',[0.5,0.5,0.5]],['legs',[0.5,0.9,0.5]]);
