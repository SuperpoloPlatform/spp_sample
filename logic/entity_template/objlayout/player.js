	...
	PLAYER = {
		...
		event : {
			...
			"pccommandinput_add_yang1" : function() {
				...
				var yang1 = Entities.CreateEntity(YANG_TPL, [-Math.random()*10, 0, -Math.random()*10]);
				yang1.pcarray['pcmesh'].PerformAction('SetAnimation', ['animation','run'], ['cycle', true], ['reset', false]);
			},
