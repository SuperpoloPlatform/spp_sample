...
try {
	...
	// mesh_select
	prop_pmsel = Entities.CreatePropertyClass(player,'pcmeshselect');
	prop_pmsel.PerformAction('SetCamera', ['entity', 'player']);
	prop_pmsel.PerformAction('SetMouseButtons', ['button', 'l']);
	prop_pmsel.SetProperty('global', true);
	prop_pmsel.SetProperty('follow', true);
