...
try {
	...
	PLAYER = {
		...
		event : {
			"pccommandinput_run1" : function(e)
			{
				Event.Send({
					name : "effect.wander.run",
					self : this
				});
			},
			...
			{
				Event.Send({
					name : "effect.wander.resume",
					self : this
				});
			},
			"pccommandinput_stop1" : function(e)
			{
				Event.Send({
					name : "effect.wander.stop",
					self : this
				});
			},
