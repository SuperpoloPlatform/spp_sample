...
try {
	...
	// 给monster设定一种能力，ActorMove （ActorMove依赖linearmove）
	m_prop_pcactor = Entities.CreatePropertyClass(monster, 'pcactormove');
	m_prop_ment = Entities.CreatePropertyClass(monster,'pclinearmovement');
	
	// monster向前走
	m_prop_pcactor.PerformAction('Forward', ['start', true]);
